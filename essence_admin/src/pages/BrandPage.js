...
const TABLE_HEAD = [{ id: 'name', label: 'Name', alignRight: false }, { id: 'edit' }, { id: 'delete' }];
// ------ Delete Modal ----
const style = {
  position: 'absolute',
  top: '50%',
...
export default function BrandPage() {
  ...
  // New Brand Create
  const addBrand = () => {
    navigate('/dashboard/brand/addbrand');
  };
  const editBrand = (_id) => {
    navigate(`/dashboard/brand/editbrand/${_id}`);
    console.log('id', _id);
  };
  const deleteBrand = (brand_id) => {
    axios.delete(`${baseURL}/brands/delete_brand/${brand_id}`).then((res) => {
      handleClose();
      fetchData();
    });
  };
    ...
    <>
      ...
      <Container>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Button variant="contained" startIcon={<Iconify icon="eva:plus-fill" />} onClick={addBrand}>
            New Brand
          </Button>
        </Stack>
                      ...
                      <TableRow hover key={_id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          <Stack direction="row" alignItems="center" spacing={2}>
                            <Avatar alt={name} src={`${baseURL}/uploads/brands/${image}`} />
                        ...
                        >
                          <Fade in={open}>
                            <Box sx={style}>
                              ...
                              <Button variant="contained" sx={{ m: '20px 12px' }} onClick={() => deleteBrand(brandID)}>
                                YES
                              </Button>
