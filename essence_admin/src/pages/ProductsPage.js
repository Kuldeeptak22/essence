...
export default function BrandPage() {
  ...
  const deleteProduct = (product_id) => {
    axios.delete(`${baseURL}/products/delete_product/${product_id}`).then((res) => {
      handleClose();
      fetchData();
    });
  };
    ...
    <>
      ...
      <Container>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Button variant="contained" startIcon={<Iconify icon="eva:plus-fill" />} onClick={addProduct}>
            New Product
          </Button>
        </Stack>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { _id, name, category, subcategory, brand, quantity, price, images, thumbnail } = row;
                      ...
                      <TableRow hover key={_id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          <Stack direction="row" alignItems="center" spacing={2}>
                            <Avatar alt={name} src={`${baseURL}/uploads/products/${thumbnail}`} />
                        ...
                        <TableCell align="left">
                          <AvatarGroup max={4}>
                            {images &&
                              images.map((image) => (
                                <Avatar alt={image} src={`${baseURL}/uploads/products/${image}`} key={image} />
                              ))}
                          </AvatarGroup>
                        </TableCell>
